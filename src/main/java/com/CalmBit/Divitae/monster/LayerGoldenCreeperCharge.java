...
public class LayerGoldenCreeperCharge implements LayerRenderer<EntityGoldenCreeper> {
    ...
    private static final ResourceLocation LIGHTNING_TEXTURE = new ResourceLocation(Divitae.DIVITAE_MOD_ID, "textures/entity/golden_creeper/golden_creeper_armor.png");
