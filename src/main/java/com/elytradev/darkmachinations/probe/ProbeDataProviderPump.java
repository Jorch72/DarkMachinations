...
public class ProbeDataProviderPump implements IProbeDataProvider {
	...
	public void provideProbeData(List<IProbeData> data) {
		...
		data.add(new ProbeDataFluid(fluidTank));
	...
	public void updateProbeFluidTank(FluidTank fluidTank) {
